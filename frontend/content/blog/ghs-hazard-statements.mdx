...
Hazard statements connect to a chemical's [hazard class and category](/blog/chemical-hazard-examples). The hazard class groups products with similar properties, such as flammable solids or carcinogens. The hazard category then provides numerical severity ranking from 1 through 4. Category 1 shows the most severe hazard.
...
Signal words communicate hazard severity using "Danger" or "Warning". Hazard statements describe the chemical's risks, such as "Causes damage to kidneys through prolonged or repeated exposure when absorbed through the skin". Precautionary statements address prevention, response and storage measures. [Pictograms](/blog/ghs-classification-of-chemicals) provide visual hazard warnings through standardized symbols.
